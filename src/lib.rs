...
async fn proxy_handler(
    ...
    println!("Starting proxy handler");
    ...
    let host_header_str = get_host_header(&req);
...
mod tests {
    ...
    #[tokio::test]
    async fn test_get_host_header_http1() {
    ...
    #[tokio::test]
    async fn test_get_host_header_http1_none() {
        let request = Request::builder()
            .method("GET")
            .version(Version::HTTP_10)
            .uri("https://localhost:4000/test")
    ...
    #[tokio::test]
    async fn test_get_host_header_http2() {
        let request = Request::builder()
            .method("GET")
    ...
    #[tokio::test]
    async fn test_get_host_header_http2_none() {
        let request = Request::builder()
            .method("GET")
            .version(Version::HTTP_2)
            .uri("https://localhost:4000/test")
